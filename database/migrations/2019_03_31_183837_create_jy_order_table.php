...
class CreateJyOrderTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('jy_order', function (Blueprint $table) {
            ...
            $table->tinyInteger("order_status")->default(0)->comment("订单状态 1未确认 2已确认 3取消 4退货");
            $table->tinyInteger("shipping_status")->default(0)->comment("发货状态 1代发货 2已发货 3已收货 4退货");
            $table->tinyInteger("pay_status")->default(0)->comment("付款状态 1未支付 2支付中 3支付成功");
            ...
            $table->string("zipcode",60)->default("")->comment("收货人的邮政编码");
