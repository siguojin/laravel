...
@section('title','管理后台-商品sku')

<!--页面顶部信息-->
@section('pageHeader')
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> 商品sku <span>Subtitle goes here...</span></h2>
...
@section('content')
    ...
    <p>
        ...
        <button :class="tab == 2 ? 'btn btn-sm btn-success': 'btn btn-sm btn-danger'" data-tab="2" @click="switchTab">商品sku</button>&nbsp;
    </p>
    <!--标签切换-->
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            ...
            <h4 class="panel-title">商品sku表单</h4>
        </div>
        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==2">
                    ...
                    <!-- 相册添加表单-->
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                               <select name="sku1[][attr_id]" class="form-control">
                                    <option v-for="sku in attr_name_list" :value="sku.id" @change="getAttrValue">{sku.attr_name}</option>
