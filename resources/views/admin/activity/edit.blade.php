        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="/admin/activity/doEdit" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea class="form-control" rows="5" name="activity_config" value="">{{$info->activity_config}}</textarea>
                    </div>
                </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                            <button class="btn btn-primary btn-danger" id="btn-save">修改</button>&nbsp;
                        </div>
                    </div>
                </div><!-- panel-footer -->
            </form>
