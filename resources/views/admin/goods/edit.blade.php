                        ...
                        <select class="form-control" name="brand_id">
                            @if(!empty($brand))
                                @foreach($brand as $key =>  $v)
                                    <option value="{{$v['id']}}" {{$info->v_id==$v['id'] ? "selected" : ""}}>{{$v['brand_name']}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
            ...
            var goodsAdd = new Vue({
                ...
                methods:{
                    ...
                    getGoodsGallery: function(){
                        ...
                        $.ajax({
                            url: "/admin/goods/gallery/list/"+goods_id,
                            type: "post",
